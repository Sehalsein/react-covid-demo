            ...
            {search && (
                <div className="m-auto flex w-full max-w-3xl flex-col divide-y divide-solid divide-slate-200 rounded-md dark:divide-background-dark dark:bg-background-dark-alternate dark:text-slate-400">
                    {renderCollection(
                        ...
                        ({ id, value }) => {
                            return (
                                <Link href={`/country/${id}`} passHref>
                                    <div className="flex cursor-pointer items-center justify-between py-4 px-4 hover:bg-slate-100 dark:hover:bg-background-dark">
